...
<div class="card">
    ...
    <div class="grid-2">
    <?php $panelGroups = ['يمين / Right' => ['right_front_fender','right_front_door','right_rear_door','right_rear_fender','right_sill','right_a_pillar','right_b_pillar','right_roof_rail','right_c_pillar','right_d_pillar','right_platform','right_chassis'], 'يسار / Left' => ['left_front_fender','left_front_door','left_rear_door','left_rear_fender','left_sill','left_a_pillar','left_b_pillar','left_roof_rail','left_c_pillar','left_d_pillar','left_platform','left_chassis'], 'فوق / Top' => ['hood','roof','trunk_top'], 'أمام-خلف / Front-Rear' => ['trunk_door','rear_panel','trunk_floor','rear_bumper','front_bumper','front_panel']]; ?>
