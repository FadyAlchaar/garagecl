...
// Add tajawal font if present
$tajawalPath = APP_ROOT . '/assets/fonts/tajawal-Regular.ttf';
$tajawalBold = APP_ROOT . '/assets/fonts/tajawal-Bold.ttf';
if (file_exists($tajawalPath)) {
    $mpdf->fontdata['tajawal'] = [
        'R' => $tajawalPath,
        'B' => file_exists($tajawalBold) ? $tajawalBold : $tajawalPath,
    ];
    $mpdf->default_font = 'tajawal';
}
