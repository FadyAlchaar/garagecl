...
if (!defined('INSPECTION_CHECKS_DICT')) {
    define('INSPECTION_CHECKS_DICT', [
        ...
        'gearbox_noise'     => ['ar' => 'صوت سلبي من الشنجمان',                 'en' => 'Gearbox noise'],
        'gear_knock'        => ['ar' => 'ضربات أثناء تغيير الغيار',             'en' => 'Knocking during gear change'],
        ...
        'gearbox_oil_leak'  => ['ar' => 'تسريب زيت من منطقة الشنجمان',          'en' => 'Gearbox oil leak'],
